...
def report():
    ...
    try:
        statement = "SELECT ID_proyecto, numero_cdf, nombre_proy, solicitudes.filiacion_cliente FROM proyectos inner join solicitudes on proyectos.ID_solicitud = solicitudes.ID_solicitud WHERE area = 'Asistencias' and estado = 'En curso' ORDER BY numero_cdf DESC"
